...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { description: @website.description, image_url: @website.image_url, link: @website.link, title: @website.title }
    end
  ...
  test "should update website" do
    put :update, id: @website, website: { description: @website.description, image_url: @website.image_url, link: @website.link, title: @website.title }
    assert_redirected_to website_path(assigns(:website))
  end
